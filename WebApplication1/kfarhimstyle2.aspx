<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kfarhimstyle2.aspx.cs" Inherits="WebApplication1.kfarhimstyle2" %>
            ...
            <nav class="navbar navbar-inverse" style="background-color: white; border-color: white;" id="enghide">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-right" href="#" style="margin-bottom: 50px;"><img alt="Brand" style="height: 80px;" src="images/logo1.png" class="img-responsive" /></a>
                    </div>
